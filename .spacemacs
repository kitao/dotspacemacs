...
(defun dotspacemacs/layers ()
  (setq-default
   ...
   dotspacemacs-additional-packages '(format-all nim-mode)
...
(defun dotspacemacs/user-init ()
  ...
  ;;      '((left . 17) (top . 30) (width . 154) (height . 44)))
...
(defun dotspacemacs/user-config ()
  ...
  (defun switch-neotree ()
    (interactive)
    (let ((win (get-window-in-mode 'neotree-mode)))
      (cond ((focused-window-p win) (winum-select-window-1))
            (win (winum-select-window-1) (select-window win))
            (t (winum-select-window-1) (neotree-toggle)))))

  (bind-key* "C-;" 'switch-neotree)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(csv-mode nim-mode flycheck-nimsuggest commenter epc ctable concurrent deferred undohist switch-buffer-functions treemacs ht pfuture mmm-mode markdown-toc gh-md slime-company slime common-lisp-snippets xterm-color toml-mode shell-pop racer multi-term eshell-z eshell-prompt-extras esh-help disaster company-c-headers cmake-mode clang-format cargo markdown-mode rust-mode flycheck-pos-tip pos-tip flycheck yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode dash-functional helm-pydoc cython-mode company-anaconda anaconda-mode pythonic helm-company helm-c-yasnippet fuzzy company-statistics company auto-yasnippet yasnippet ac-ispell auto-complete format-all language-id ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired f evil-tutor evil-surround evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async)))
(custom-set-faces
